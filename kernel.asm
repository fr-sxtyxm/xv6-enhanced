...
801037fc:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103802:	e8 89 0d 00 00       	call   80104590 <release>
...
80103824:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103827:	c7 40 14 ad 58 10 80 	movl   $0x801058ad,0x14(%eax)
  p->context = (struct context*)sp;
...
8010385a:	e8 31 0d 00 00       	call   80104590 <release>
}
...
8010388b:	e8 00 0d 00 00       	call   80104590 <release>
...
801038d6:	68 40 77 10 80       	push   $0x80107740
801038db:	68 20 1d 11 80       	push   $0x80111d20
801038e0:	e8 3b 0b 00 00       	call   80104420 <initlock>
}
...
80103974:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103977:	e8 24 0b 00 00       	call   801044a0 <pushcli>
  c = mycpu();
8010397c:	e8 6f ff ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103981:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103987:	e8 64 0b 00 00       	call   801044f0 <popcli>
}
...
801039b3:	e8 e8 34 00 00       	call   80106ea0 <setupkvm>
...
801039d1:	e8 7a 31 00 00       	call   80106b50 <inituvm>
...
80103a3f:	68 70 77 10 80       	push   $0x80107770
80103a44:	50                   	push   %eax
80103a45:	e8 26 0e 00 00       	call   80104870 <safestrcpy>
  p->cwd = namei("/");
80103a4a:	c7 04 24 79 77 10 80 	movl   $0x80107779,(%esp)
...
80103a83:	68 57 77 10 80       	push   $0x80107757
...
80103a95:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103a98:	e8 03 0a 00 00       	call   801044a0 <pushcli>
  c = mycpu();
80103a9d:	e8 4e fe ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103aa2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103aa8:	e8 43 0a 00 00       	call   801044f0 <popcli>
  sz = curproc->sz;
...
80103abb:	e8 80 2f 00 00       	call   80106a40 <switchuvm>
  return 0;
...
80103afa:	e8 f1 32 00 00       	call   80106df0 <deallocuvm>
...
80103b16:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b19:	e8 82 09 00 00       	call   801044a0 <pushcli>
  c = mycpu();
80103b1e:	e8 cd fd ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103b23:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b29:	e8 c2 09 00 00       	call   801044f0 <popcli>
  if((np = allocproc()) == 0){
...
80103b48:	e8 43 34 00 00       	call   80106f90 <copyuvm>
...
80103bc1:	e8 aa 0c 00 00       	call   80104870 <safestrcpy>
  pid = np->pid;
80103bc6:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103bc9:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103bd0:	e8 1b 0a 00 00       	call   801045f0 <acquire>
  np->state = RUNNABLE;
...
80103c5e:	e8 8d 09 00 00       	call   801045f0 <acquire>
...
80103dfa:	e8 f1 07 00 00       	call   801045f0 <acquire>
...
80103e9d:	68 c8 77 10 80       	push   $0x801077c8
80103ea2:	e8 d9 c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103ea7:	83 ec 0c             	sub    $0xc,%esp
80103eaa:	68 bb 77 10 80       	push   $0x801077bb
...
80103f2b:	0f 85 95 00 00 00    	jne    80103fc6 <wait+0x106>
  pushcli();
80103f31:	e8 6a 05 00 00       	call   801044a0 <pushcli>
  c = mycpu();
80103f36:	e8 b5 f9 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103f3b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f41:	e8 aa 05 00 00       	call   801044f0 <popcli>
  if(p == 0)
...
80103f89:	e8 92 2e 00 00       	call   80106e20 <freevm>
        p->pid = 0;
...
80103fb5:	e8 d6 05 00 00       	call   80104590 <release>
        return pid;
...
80103ffc:	e8 ef 05 00 00       	call   801045f0 <acquire>
  pushcli();
80104001:	e8 9a 04 00 00       	call   801044a0 <pushcli>
  c = mycpu();
80104006:	e8 e5 f8 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
8010400b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104011:	e8 da 04 00 00       	call   801044f0 <popcli>
...
80104029:	e8 62 05 00 00       	call   80104590 <release>
}
...
8010404c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
8010404f:	e8 4c 04 00 00       	call   801044a0 <pushcli>
  c = mycpu();
80104054:	e8 97 f8 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80104059:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010405f:	e8 8c 04 00 00       	call   801044f0 <popcli>
  if(p == 0)
...
80104080:	e8 6b 05 00 00       	call   801045f0 <acquire>
    release(lk);
80104085:	89 34 24             	mov    %esi,(%esp)
80104088:	e8 03 05 00 00       	call   80104590 <release>
  p->chan = chan;
...
801040aa:	e8 e1 04 00 00       	call   80104590 <release>
    acquire(lk);
...
801040bb:	5d                   	pop    %ebp
    acquire(lk);
801040bc:	e9 2f 05 00 00       	jmp    801045f0 <acquire>
...
801040e9:	68 da 77 10 80       	push   $0x801077da
801040ee:	e8 8d c2 ff ff       	call   80100380 <panic>
    panic("sleep");
801040f3:	83 ec 0c             	sub    $0xc,%esp
801040f6:	68 d4 77 10 80       	push   $0x801077d4
...
8010410f:	e8 dc 04 00 00       	call   801045f0 <acquire>
...
80104150:	c9                   	leave  
  release(&ptable.lock);
80104151:	e9 3a 04 00 00       	jmp    80104590 <release>
...
801041ab:	e8 e0 03 00 00       	call   80104590 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801041c8:	e8 c3 03 00 00       	call   80104590 <release>
}
...
801041fb:	68 7b 7b 10 80       	push   $0x80107b7b
...
8010421c:	74 ea                	je     80104208 <procdump+0x28>
      state = "???";
8010421e:	ba eb 77 10 80       	mov    $0x801077eb,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104223:	83 f8 05             	cmp    $0x5,%eax
80104226:	77 11                	ja     80104239 <procdump+0x59>
80104228:	8b 14 85 64 78 10 80 	mov    -0x7fef879c(,%eax,4),%edx
      state = "???";
8010422f:	b8 eb 77 10 80       	mov    $0x801077eb,%eax
...
8010423e:	68 ef 77 10 80       	push   $0x801077ef
...
801042a4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801042a7:	e8 f4 01 00 00       	call   801044a0 <pushcli>
  c = mycpu();
801042ac:	e8 3f f6 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
801042b1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801042b7:	e8 34 02 00 00       	call   801044f0 <popcli>
  struct proc *p = myproc(); //to get the current process structure
  //myproc() is availaible at ln:63

  //to print the process id and parent process id using the structure pointer operator and cprintf
  cprintf("Process ID: %d\n", p->pid);
801042bc:	83 ec 08             	sub    $0x8,%esp
801042bf:	ff 73 10             	push   0x10(%ebx)
801042c2:	68 ff 77 10 80       	push   $0x801077ff
801042c7:	e8 d4 c3 ff ff       	call   801006a0 <cprintf>
  cprintf("Parent Process ID: %d\n", p->parent->pid);
801042cc:	58                   	pop    %eax
801042cd:	8b 43 14             	mov    0x14(%ebx),%eax
801042d0:	5a                   	pop    %edx
801042d1:	ff 70 10             	push   0x10(%eax)
801042d4:	68 f8 77 10 80       	push   $0x801077f8
801042d9:	e8 c2 c3 ff ff       	call   801006a0 <cprintf>
...
801042fa:	68 7c 78 10 80       	push   $0x8010787c
...
80104363:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104369:	e8 02 f6 ff ff       	call   80103970 <myproc>
...
8010440b:	e8 60 f5 ff ff       	call   80103970 <myproc>
...
8010451c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104520:	e8 cb f3 ff ff       	call   801038f0 <mycpu>
...
80104535:	68 87 78 10 80       	push   $0x80107887
8010453a:	e8 41 be ff ff       	call   80100380 <panic>
    panic("popcli");
8010453f:	83 ec 0c             	sub    $0xc,%esp
80104542:	68 9e 78 10 80       	push   $0x8010789e
...
80104573:	e8 78 f3 ff ff       	call   801038f0 <mycpu>
...
8010462c:	e8 bf f2 ff ff       	call   801038f0 <mycpu>
...
801046a0:	68 ad 78 10 80       	push   $0x801078ad
...
801048e7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
801048ea:	e8 81 f0 ff ff       	call   80103970 <myproc>
...
80104927:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010492a:	e8 41 f0 ff ff       	call   80103970 <myproc>
...
80104975:	e8 f6 ef ff ff       	call   80103970 <myproc>
...
80104983:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104986:	e8 e5 ef ff ff       	call   80103970 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
801049c6:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
801049c9:	e8 a2 ef ff ff       	call   80103970 <myproc>
801049ce:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
801049d0:	e8 9b ef ff ff       	call   80103970 <myproc>
...
801049de:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
801049e1:	e8 8a ef ff ff       	call   80103970 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104a5b:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
80104a5e:	e8 0d ef ff ff       	call   80103970 <myproc>
  if(addr >= curproc->sz)
...
80104ab4:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104ab7:	e8 b4 ee ff ff       	call   80103970 <myproc>
...
80104acc:	8b 14 85 e0 78 10 80 	mov    -0x7fef8720(,%eax,4),%edx
...
80104af8:	68 b5 78 10 80       	push   $0x801078b5
...
80104c54:	68 58 79 10 80       	push   $0x80107958
...
80104c6c:	68 57 79 10 80       	push   $0x80107957
...
80104c81:	68 4b 79 10 80       	push   $0x8010794b
...
80104c9f:	68 5a 79 10 80       	push   $0x8010795a
80104ca4:	e8 d7 b6 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104ca9:	83 ec 0c             	sub    $0xc,%esp
80104cac:	68 3c 79 10 80       	push   $0x8010793c
...
80104cee:	74 20                	je     80104d10 <sys_dup+0x50>
  struct proc *curproc = myproc();
80104cf0:	e8 7b ec ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80104d60:	e8 0b ec ff ff       	call   80103970 <myproc>
...
80104de0:	e8 8b eb ff ff       	call   80103970 <myproc>
...
80104e60:	e8 0b eb ff ff       	call   80103970 <myproc>
...
80104e71:	74 25                	je     80104e98 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
80104e73:	e8 f8 ea ff ff       	call   80103970 <myproc>
  fileclose(f);
...
801050ad:	58                   	pop    %eax
801050ae:	5a                   	pop    %edx
801050af:	68 58 79 10 80       	push   $0x80107958
...
801050c8:	68 57 79 10 80       	push   $0x80107957
...
801052b7:	74 23                	je     801052dc <sys_open+0x9c>
  struct proc *curproc = myproc();
801052b9:	e8 b2 e6 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
{
  return fork();
801056e0:	e9 2b e4 ff ff       	jmp    80103b10 <fork>
...
801056f3:	83 ec 08             	sub    $0x8,%esp
  exit();
801056f6:	e8 95 e6 ff ff       	call   80103d90 <exit>
...
{
  return wait();
80105700:	e9 bb e7 ff ff       	jmp    80103ec0 <wait>
...
8010572e:	e8 2d ea ff ff       	call   80104160 <kill>
...
80105753:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105756:	e8 15 e2 ff ff       	call   80103970 <myproc>
...
80105777:	78 27                	js     801057a0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105779:	e8 f2 e1 ff ff       	call   80103970 <myproc>
  if(growproc(n) < 0)
...
80105786:	e8 05 e3 ff ff       	call   80103a90 <growproc>
...
801057fd:	e8 3e e8 ff ff       	call   80104040 <sleep>
  while(ticks - ticks0 < n){
...
sys_prsd(void){
  return prsd();
80105890:	e9 0b ea ff ff       	jmp    801042a0 <prsd>
...
80105896:	06                   	push   %es
  pushl %fs
80105897:	0f a0                	push   %fs
  pushl %gs
80105899:	0f a8                	push   %gs
  pushal
8010589b:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
8010589c:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801058a0:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801058a2:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
801058a4:	54                   	push   %esp
  call trap
801058a5:	e8 c6 00 00 00       	call   80105970 <trap>
  addl $4, %esp
801058aa:	83 c4 04             	add    $0x4,%esp
...
801058ad:	61                   	popa   
  popl %gs
801058ae:	0f a9                	pop    %gs
  popl %fs
801058b0:	0f a1                	pop    %fs
  popl %es
801058b2:	07                   	pop    %es
  popl %ds
801058b3:	1f                   	pop    %ds
...
8010590e:	00 00 ef 
  initlock(&tickslock, "time");
80105911:	68 9d 79 10 80       	push   $0x8010799d
...
80105994:	ff 24 85 44 7a 10 80 	jmp    *-0x7fef85bc(,%eax,4)
...
801059aa:	e8 c1 df ff ff       	call   80103970 <myproc>
801059af:	85 c0                	test   %eax,%eax
801059b1:	74 1d                	je     801059d0 <trap+0x60>
801059b3:	e8 b8 df ff ff       	call   80103970 <myproc>
...
80105a75:	68 00 7a 10 80       	push   $0x80107a00
...
80105aa4:	0f 85 3e ff ff ff    	jne    801059e8 <trap+0x78>
    yield();
80105aaa:	e8 41 e5 ff ff       	call   80103ff0 <yield>
...
80105ac7:	68 a8 79 10 80       	push   $0x801079a8
...
80105b05:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105b08:	e8 a3 ef ff ff       	call   80104ab0 <syscall>
    if(myproc()->killed)
...
80105b23:	5d                   	pop    %ebp
      exit();
80105b24:	e9 67 e2 ff ff       	jmp    80103d90 <exit>
...
80105bb1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    exit();
80105bb8:	e8 d3 e1 ff ff       	call   80103d90 <exit>
...
80105be3:	68 cc 79 10 80       	push   $0x801079cc
80105be8:	e8 b3 aa ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105bed:	83 c4 14             	add    $0x14,%esp
80105bf0:	68 a2 79 10 80       	push   $0x801079a2
...
80105c9c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105c9f:	bf c4 7a 10 80       	mov    $0x80107ac4,%edi
...
80105d87:	6a 00                	push   $0x0
  jmp alltraps
80105d89:	e9 07 fb ff ff       	jmp    80105895 <alltraps>
...
80105d90:	6a 01                	push   $0x1
  jmp alltraps
80105d92:	e9 fe fa ff ff       	jmp    80105895 <alltraps>
...
80105d99:	6a 02                	push   $0x2
  jmp alltraps
80105d9b:	e9 f5 fa ff ff       	jmp    80105895 <alltraps>
...
80105da2:	6a 03                	push   $0x3
  jmp alltraps
80105da4:	e9 ec fa ff ff       	jmp    80105895 <alltraps>
...
80105dab:	6a 04                	push   $0x4
  jmp alltraps
80105dad:	e9 e3 fa ff ff       	jmp    80105895 <alltraps>
...
80105db4:	6a 05                	push   $0x5
  jmp alltraps
80105db6:	e9 da fa ff ff       	jmp    80105895 <alltraps>
...
80105dbd:	6a 06                	push   $0x6
  jmp alltraps
80105dbf:	e9 d1 fa ff ff       	jmp    80105895 <alltraps>
...
80105dc6:	6a 07                	push   $0x7
  jmp alltraps
80105dc8:	e9 c8 fa ff ff       	jmp    80105895 <alltraps>
...
80105dcd:	6a 08                	push   $0x8
  jmp alltraps
80105dcf:	e9 c1 fa ff ff       	jmp    80105895 <alltraps>
...
80105dd6:	6a 09                	push   $0x9
  jmp alltraps
80105dd8:	e9 b8 fa ff ff       	jmp    80105895 <alltraps>
...
80105ddd:	6a 0a                	push   $0xa
  jmp alltraps
80105ddf:	e9 b1 fa ff ff       	jmp    80105895 <alltraps>
...
80105de4:	6a 0b                	push   $0xb
  jmp alltraps
80105de6:	e9 aa fa ff ff       	jmp    80105895 <alltraps>
...
80105deb:	6a 0c                	push   $0xc
  jmp alltraps
80105ded:	e9 a3 fa ff ff       	jmp    80105895 <alltraps>
...
80105df2:	6a 0d                	push   $0xd
  jmp alltraps
80105df4:	e9 9c fa ff ff       	jmp    80105895 <alltraps>
...
80105df9:	6a 0e                	push   $0xe
  jmp alltraps
80105dfb:	e9 95 fa ff ff       	jmp    80105895 <alltraps>
...
80105e02:	6a 0f                	push   $0xf
  jmp alltraps
80105e04:	e9 8c fa ff ff       	jmp    80105895 <alltraps>
...
80105e0b:	6a 10                	push   $0x10
  jmp alltraps
80105e0d:	e9 83 fa ff ff       	jmp    80105895 <alltraps>
...
80105e12:	6a 11                	push   $0x11
  jmp alltraps
80105e14:	e9 7c fa ff ff       	jmp    80105895 <alltraps>
...
80105e1b:	6a 12                	push   $0x12
  jmp alltraps
80105e1d:	e9 73 fa ff ff       	jmp    80105895 <alltraps>
...
80105e24:	6a 13                	push   $0x13
  jmp alltraps
80105e26:	e9 6a fa ff ff       	jmp    80105895 <alltraps>
...
80105e2d:	6a 14                	push   $0x14
  jmp alltraps
80105e2f:	e9 61 fa ff ff       	jmp    80105895 <alltraps>
...
80105e36:	6a 15                	push   $0x15
  jmp alltraps
80105e38:	e9 58 fa ff ff       	jmp    80105895 <alltraps>
...
80105e3f:	6a 16                	push   $0x16
  jmp alltraps
80105e41:	e9 4f fa ff ff       	jmp    80105895 <alltraps>
...
80105e48:	6a 17                	push   $0x17
  jmp alltraps
80105e4a:	e9 46 fa ff ff       	jmp    80105895 <alltraps>
...
80105e51:	6a 18                	push   $0x18
  jmp alltraps
80105e53:	e9 3d fa ff ff       	jmp    80105895 <alltraps>
...
80105e5a:	6a 19                	push   $0x19
  jmp alltraps
80105e5c:	e9 34 fa ff ff       	jmp    80105895 <alltraps>
...
80105e63:	6a 1a                	push   $0x1a
  jmp alltraps
80105e65:	e9 2b fa ff ff       	jmp    80105895 <alltraps>
...
80105e6c:	6a 1b                	push   $0x1b
  jmp alltraps
80105e6e:	e9 22 fa ff ff       	jmp    80105895 <alltraps>
...
80105e75:	6a 1c                	push   $0x1c
  jmp alltraps
80105e77:	e9 19 fa ff ff       	jmp    80105895 <alltraps>
...
80105e7e:	6a 1d                	push   $0x1d
  jmp alltraps
80105e80:	e9 10 fa ff ff       	jmp    80105895 <alltraps>
...
80105e87:	6a 1e                	push   $0x1e
  jmp alltraps
80105e89:	e9 07 fa ff ff       	jmp    80105895 <alltraps>
...
80105e90:	6a 1f                	push   $0x1f
  jmp alltraps
80105e92:	e9 fe f9 ff ff       	jmp    80105895 <alltraps>
...
80105e99:	6a 20                	push   $0x20
  jmp alltraps
80105e9b:	e9 f5 f9 ff ff       	jmp    80105895 <alltraps>
...
80105ea2:	6a 21                	push   $0x21
  jmp alltraps
80105ea4:	e9 ec f9 ff ff       	jmp    80105895 <alltraps>
...
80105eab:	6a 22                	push   $0x22
  jmp alltraps
80105ead:	e9 e3 f9 ff ff       	jmp    80105895 <alltraps>
...
80105eb4:	6a 23                	push   $0x23
  jmp alltraps
80105eb6:	e9 da f9 ff ff       	jmp    80105895 <alltraps>
...
80105ebd:	6a 24                	push   $0x24
  jmp alltraps
80105ebf:	e9 d1 f9 ff ff       	jmp    80105895 <alltraps>
...
80105ec6:	6a 25                	push   $0x25
  jmp alltraps
80105ec8:	e9 c8 f9 ff ff       	jmp    80105895 <alltraps>
...
80105ecf:	6a 26                	push   $0x26
  jmp alltraps
80105ed1:	e9 bf f9 ff ff       	jmp    80105895 <alltraps>
...
80105ed8:	6a 27                	push   $0x27
  jmp alltraps
80105eda:	e9 b6 f9 ff ff       	jmp    80105895 <alltraps>
...
80105ee1:	6a 28                	push   $0x28
  jmp alltraps
80105ee3:	e9 ad f9 ff ff       	jmp    80105895 <alltraps>
...
80105eea:	6a 29                	push   $0x29
  jmp alltraps
80105eec:	e9 a4 f9 ff ff       	jmp    80105895 <alltraps>
...
80105ef3:	6a 2a                	push   $0x2a
  jmp alltraps
80105ef5:	e9 9b f9 ff ff       	jmp    80105895 <alltraps>
...
80105efc:	6a 2b                	push   $0x2b
  jmp alltraps
80105efe:	e9 92 f9 ff ff       	jmp    80105895 <alltraps>
...
80105f05:	6a 2c                	push   $0x2c
  jmp alltraps
80105f07:	e9 89 f9 ff ff       	jmp    80105895 <alltraps>
...
80105f0e:	6a 2d                	push   $0x2d
  jmp alltraps
80105f10:	e9 80 f9 ff ff       	jmp    80105895 <alltraps>
...
80105f17:	6a 2e                	push   $0x2e
  jmp alltraps
80105f19:	e9 77 f9 ff ff       	jmp    80105895 <alltraps>
...
80105f20:	6a 2f                	push   $0x2f
  jmp alltraps
80105f22:	e9 6e f9 ff ff       	jmp    80105895 <alltraps>
...
80105f29:	6a 30                	push   $0x30
  jmp alltraps
80105f2b:	e9 65 f9 ff ff       	jmp    80105895 <alltraps>
...
80105f32:	6a 31                	push   $0x31
  jmp alltraps
80105f34:	e9 5c f9 ff ff       	jmp    80105895 <alltraps>
...
80105f3b:	6a 32                	push   $0x32
  jmp alltraps
80105f3d:	e9 53 f9 ff ff       	jmp    80105895 <alltraps>
...
80105f44:	6a 33                	push   $0x33
  jmp alltraps
80105f46:	e9 4a f9 ff ff       	jmp    80105895 <alltraps>
...
80105f4d:	6a 34                	push   $0x34
  jmp alltraps
80105f4f:	e9 41 f9 ff ff       	jmp    80105895 <alltraps>
...
80105f56:	6a 35                	push   $0x35
  jmp alltraps
80105f58:	e9 38 f9 ff ff       	jmp    80105895 <alltraps>
...
80105f5f:	6a 36                	push   $0x36
  jmp alltraps
80105f61:	e9 2f f9 ff ff       	jmp    80105895 <alltraps>
...
80105f68:	6a 37                	push   $0x37
  jmp alltraps
80105f6a:	e9 26 f9 ff ff       	jmp    80105895 <alltraps>
...
80105f71:	6a 38                	push   $0x38
  jmp alltraps
80105f73:	e9 1d f9 ff ff       	jmp    80105895 <alltraps>
...
80105f7a:	6a 39                	push   $0x39
  jmp alltraps
80105f7c:	e9 14 f9 ff ff       	jmp    80105895 <alltraps>
...
80105f83:	6a 3a                	push   $0x3a
  jmp alltraps
80105f85:	e9 0b f9 ff ff       	jmp    80105895 <alltraps>
...
80105f8c:	6a 3b                	push   $0x3b
  jmp alltraps
80105f8e:	e9 02 f9 ff ff       	jmp    80105895 <alltraps>
...
80105f95:	6a 3c                	push   $0x3c
  jmp alltraps
80105f97:	e9 f9 f8 ff ff       	jmp    80105895 <alltraps>
...
80105f9e:	6a 3d                	push   $0x3d
  jmp alltraps
80105fa0:	e9 f0 f8 ff ff       	jmp    80105895 <alltraps>
...
80105fa7:	6a 3e                	push   $0x3e
  jmp alltraps
80105fa9:	e9 e7 f8 ff ff       	jmp    80105895 <alltraps>
...
80105fb0:	6a 3f                	push   $0x3f
  jmp alltraps
80105fb2:	e9 de f8 ff ff       	jmp    80105895 <alltraps>
...
80105fb9:	6a 40                	push   $0x40
  jmp alltraps
80105fbb:	e9 d5 f8 ff ff       	jmp    80105895 <alltraps>
...
80105fc2:	6a 41                	push   $0x41
  jmp alltraps
80105fc4:	e9 cc f8 ff ff       	jmp    80105895 <alltraps>
...
80105fcb:	6a 42                	push   $0x42
  jmp alltraps
80105fcd:	e9 c3 f8 ff ff       	jmp    80105895 <alltraps>
...
80105fd4:	6a 43                	push   $0x43
  jmp alltraps
80105fd6:	e9 ba f8 ff ff       	jmp    80105895 <alltraps>
...
80105fdd:	6a 44                	push   $0x44
  jmp alltraps
80105fdf:	e9 b1 f8 ff ff       	jmp    80105895 <alltraps>
...
80105fe6:	6a 45                	push   $0x45
  jmp alltraps
80105fe8:	e9 a8 f8 ff ff       	jmp    80105895 <alltraps>
...
80105fef:	6a 46                	push   $0x46
  jmp alltraps
80105ff1:	e9 9f f8 ff ff       	jmp    80105895 <alltraps>
...
80105ff8:	6a 47                	push   $0x47
  jmp alltraps
80105ffa:	e9 96 f8 ff ff       	jmp    80105895 <alltraps>
...
80106001:	6a 48                	push   $0x48
  jmp alltraps
80106003:	e9 8d f8 ff ff       	jmp    80105895 <alltraps>
...
8010600a:	6a 49                	push   $0x49
  jmp alltraps
8010600c:	e9 84 f8 ff ff       	jmp    80105895 <alltraps>
...
80106013:	6a 4a                	push   $0x4a
  jmp alltraps
80106015:	e9 7b f8 ff ff       	jmp    80105895 <alltraps>
...
8010601c:	6a 4b                	push   $0x4b
  jmp alltraps
8010601e:	e9 72 f8 ff ff       	jmp    80105895 <alltraps>
...
80106025:	6a 4c                	push   $0x4c
  jmp alltraps
80106027:	e9 69 f8 ff ff       	jmp    80105895 <alltraps>
...
8010602e:	6a 4d                	push   $0x4d
  jmp alltraps
80106030:	e9 60 f8 ff ff       	jmp    80105895 <alltraps>
...
80106037:	6a 4e                	push   $0x4e
  jmp alltraps
80106039:	e9 57 f8 ff ff       	jmp    80105895 <alltraps>
...
80106040:	6a 4f                	push   $0x4f
  jmp alltraps
80106042:	e9 4e f8 ff ff       	jmp    80105895 <alltraps>
...
80106049:	6a 50                	push   $0x50
  jmp alltraps
8010604b:	e9 45 f8 ff ff       	jmp    80105895 <alltraps>
...
80106052:	6a 51                	push   $0x51
  jmp alltraps
80106054:	e9 3c f8 ff ff       	jmp    80105895 <alltraps>
...
8010605b:	6a 52                	push   $0x52
  jmp alltraps
8010605d:	e9 33 f8 ff ff       	jmp    80105895 <alltraps>
...
80106064:	6a 53                	push   $0x53
  jmp alltraps
80106066:	e9 2a f8 ff ff       	jmp    80105895 <alltraps>
...
8010606d:	6a 54                	push   $0x54
  jmp alltraps
8010606f:	e9 21 f8 ff ff       	jmp    80105895 <alltraps>
...
80106076:	6a 55                	push   $0x55
  jmp alltraps
80106078:	e9 18 f8 ff ff       	jmp    80105895 <alltraps>
...
8010607f:	6a 56                	push   $0x56
  jmp alltraps
80106081:	e9 0f f8 ff ff       	jmp    80105895 <alltraps>
...
80106088:	6a 57                	push   $0x57
  jmp alltraps
8010608a:	e9 06 f8 ff ff       	jmp    80105895 <alltraps>
...
80106091:	6a 58                	push   $0x58
  jmp alltraps
80106093:	e9 fd f7 ff ff       	jmp    80105895 <alltraps>
...
8010609a:	6a 59                	push   $0x59
  jmp alltraps
8010609c:	e9 f4 f7 ff ff       	jmp    80105895 <alltraps>
...
801060a3:	6a 5a                	push   $0x5a
  jmp alltraps
801060a5:	e9 eb f7 ff ff       	jmp    80105895 <alltraps>
...
801060ac:	6a 5b                	push   $0x5b
  jmp alltraps
801060ae:	e9 e2 f7 ff ff       	jmp    80105895 <alltraps>
...
801060b5:	6a 5c                	push   $0x5c
  jmp alltraps
801060b7:	e9 d9 f7 ff ff       	jmp    80105895 <alltraps>
...
801060be:	6a 5d                	push   $0x5d
  jmp alltraps
801060c0:	e9 d0 f7 ff ff       	jmp    80105895 <alltraps>
...
801060c7:	6a 5e                	push   $0x5e
  jmp alltraps
801060c9:	e9 c7 f7 ff ff       	jmp    80105895 <alltraps>
...
801060d0:	6a 5f                	push   $0x5f
  jmp alltraps
801060d2:	e9 be f7 ff ff       	jmp    80105895 <alltraps>
...
801060d9:	6a 60                	push   $0x60
  jmp alltraps
801060db:	e9 b5 f7 ff ff       	jmp    80105895 <alltraps>
...
801060e2:	6a 61                	push   $0x61
  jmp alltraps
801060e4:	e9 ac f7 ff ff       	jmp    80105895 <alltraps>
...
801060eb:	6a 62                	push   $0x62
  jmp alltraps
801060ed:	e9 a3 f7 ff ff       	jmp    80105895 <alltraps>
...
801060f4:	6a 63                	push   $0x63
  jmp alltraps
801060f6:	e9 9a f7 ff ff       	jmp    80105895 <alltraps>
...
801060fd:	6a 64                	push   $0x64
  jmp alltraps
801060ff:	e9 91 f7 ff ff       	jmp    80105895 <alltraps>
...
80106106:	6a 65                	push   $0x65
  jmp alltraps
80106108:	e9 88 f7 ff ff       	jmp    80105895 <alltraps>
...
8010610f:	6a 66                	push   $0x66
  jmp alltraps
80106111:	e9 7f f7 ff ff       	jmp    80105895 <alltraps>
...
80106118:	6a 67                	push   $0x67
  jmp alltraps
8010611a:	e9 76 f7 ff ff       	jmp    80105895 <alltraps>
...
80106121:	6a 68                	push   $0x68
  jmp alltraps
80106123:	e9 6d f7 ff ff       	jmp    80105895 <alltraps>
...
8010612a:	6a 69                	push   $0x69
  jmp alltraps
8010612c:	e9 64 f7 ff ff       	jmp    80105895 <alltraps>
...
80106133:	6a 6a                	push   $0x6a
  jmp alltraps
80106135:	e9 5b f7 ff ff       	jmp    80105895 <alltraps>
...
8010613c:	6a 6b                	push   $0x6b
  jmp alltraps
8010613e:	e9 52 f7 ff ff       	jmp    80105895 <alltraps>
...
80106145:	6a 6c                	push   $0x6c
  jmp alltraps
80106147:	e9 49 f7 ff ff       	jmp    80105895 <alltraps>
...
8010614e:	6a 6d                	push   $0x6d
  jmp alltraps
80106150:	e9 40 f7 ff ff       	jmp    80105895 <alltraps>
...
80106157:	6a 6e                	push   $0x6e
  jmp alltraps
80106159:	e9 37 f7 ff ff       	jmp    80105895 <alltraps>
...
80106160:	6a 6f                	push   $0x6f
  jmp alltraps
80106162:	e9 2e f7 ff ff       	jmp    80105895 <alltraps>
...
80106169:	6a 70                	push   $0x70
  jmp alltraps
8010616b:	e9 25 f7 ff ff       	jmp    80105895 <alltraps>
...
80106172:	6a 71                	push   $0x71
  jmp alltraps
80106174:	e9 1c f7 ff ff       	jmp    80105895 <alltraps>
...
8010617b:	6a 72                	push   $0x72
  jmp alltraps
8010617d:	e9 13 f7 ff ff       	jmp    80105895 <alltraps>
...
80106184:	6a 73                	push   $0x73
  jmp alltraps
80106186:	e9 0a f7 ff ff       	jmp    80105895 <alltraps>
...
8010618d:	6a 74                	push   $0x74
  jmp alltraps
8010618f:	e9 01 f7 ff ff       	jmp    80105895 <alltraps>
...
80106196:	6a 75                	push   $0x75
  jmp alltraps
80106198:	e9 f8 f6 ff ff       	jmp    80105895 <alltraps>
...
8010619f:	6a 76                	push   $0x76
  jmp alltraps
801061a1:	e9 ef f6 ff ff       	jmp    80105895 <alltraps>
...
801061a8:	6a 77                	push   $0x77
  jmp alltraps
801061aa:	e9 e6 f6 ff ff       	jmp    80105895 <alltraps>
...
801061b1:	6a 78                	push   $0x78
  jmp alltraps
801061b3:	e9 dd f6 ff ff       	jmp    80105895 <alltraps>
...
801061ba:	6a 79                	push   $0x79
  jmp alltraps
801061bc:	e9 d4 f6 ff ff       	jmp    80105895 <alltraps>
...
801061c3:	6a 7a                	push   $0x7a
  jmp alltraps
801061c5:	e9 cb f6 ff ff       	jmp    80105895 <alltraps>
...
801061cc:	6a 7b                	push   $0x7b
  jmp alltraps
801061ce:	e9 c2 f6 ff ff       	jmp    80105895 <alltraps>
...
801061d5:	6a 7c                	push   $0x7c
  jmp alltraps
801061d7:	e9 b9 f6 ff ff       	jmp    80105895 <alltraps>
...
801061de:	6a 7d                	push   $0x7d
  jmp alltraps
801061e0:	e9 b0 f6 ff ff       	jmp    80105895 <alltraps>
...
801061e7:	6a 7e                	push   $0x7e
  jmp alltraps
801061e9:	e9 a7 f6 ff ff       	jmp    80105895 <alltraps>
...
801061f0:	6a 7f                	push   $0x7f
  jmp alltraps
801061f2:	e9 9e f6 ff ff       	jmp    80105895 <alltraps>
...
801061f9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801061fe:	e9 92 f6 ff ff       	jmp    80105895 <alltraps>
...
80106205:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010620a:	e9 86 f6 ff ff       	jmp    80105895 <alltraps>
...
80106211:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106216:	e9 7a f6 ff ff       	jmp    80105895 <alltraps>
...
8010621d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106222:	e9 6e f6 ff ff       	jmp    80105895 <alltraps>
...
80106229:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010622e:	e9 62 f6 ff ff       	jmp    80105895 <alltraps>
...
80106235:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010623a:	e9 56 f6 ff ff       	jmp    80105895 <alltraps>
...
80106241:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106246:	e9 4a f6 ff ff       	jmp    80105895 <alltraps>
...
8010624d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106252:	e9 3e f6 ff ff       	jmp    80105895 <alltraps>
...
80106259:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010625e:	e9 32 f6 ff ff       	jmp    80105895 <alltraps>
...
80106265:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010626a:	e9 26 f6 ff ff       	jmp    80105895 <alltraps>
...
80106271:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106276:	e9 1a f6 ff ff       	jmp    80105895 <alltraps>
...
8010627d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106282:	e9 0e f6 ff ff       	jmp    80105895 <alltraps>
...
80106289:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010628e:	e9 02 f6 ff ff       	jmp    80105895 <alltraps>
...
80106295:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010629a:	e9 f6 f5 ff ff       	jmp    80105895 <alltraps>
...
801062a1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801062a6:	e9 ea f5 ff ff       	jmp    80105895 <alltraps>
...
801062ad:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801062b2:	e9 de f5 ff ff       	jmp    80105895 <alltraps>
...
801062b9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801062be:	e9 d2 f5 ff ff       	jmp    80105895 <alltraps>
...
801062c5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801062ca:	e9 c6 f5 ff ff       	jmp    80105895 <alltraps>
...
801062d1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801062d6:	e9 ba f5 ff ff       	jmp    80105895 <alltraps>
...
801062dd:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801062e2:	e9 ae f5 ff ff       	jmp    80105895 <alltraps>
...
801062e9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801062ee:	e9 a2 f5 ff ff       	jmp    80105895 <alltraps>
...
801062f5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801062fa:	e9 96 f5 ff ff       	jmp    80105895 <alltraps>
...
80106301:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106306:	e9 8a f5 ff ff       	jmp    80105895 <alltraps>
...
8010630d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106312:	e9 7e f5 ff ff       	jmp    80105895 <alltraps>
...
80106319:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010631e:	e9 72 f5 ff ff       	jmp    80105895 <alltraps>
...
80106325:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010632a:	e9 66 f5 ff ff       	jmp    80105895 <alltraps>
...
80106331:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106336:	e9 5a f5 ff ff       	jmp    80105895 <alltraps>
...
8010633d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106342:	e9 4e f5 ff ff       	jmp    80105895 <alltraps>
...
80106349:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010634e:	e9 42 f5 ff ff       	jmp    80105895 <alltraps>
...
80106355:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010635a:	e9 36 f5 ff ff       	jmp    80105895 <alltraps>
...
80106361:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106366:	e9 2a f5 ff ff       	jmp    80105895 <alltraps>
...
8010636d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106372:	e9 1e f5 ff ff       	jmp    80105895 <alltraps>
...
80106379:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010637e:	e9 12 f5 ff ff       	jmp    80105895 <alltraps>
...
80106385:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010638a:	e9 06 f5 ff ff       	jmp    80105895 <alltraps>
...
80106391:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106396:	e9 fa f4 ff ff       	jmp    80105895 <alltraps>
...
8010639d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801063a2:	e9 ee f4 ff ff       	jmp    80105895 <alltraps>
...
801063a9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801063ae:	e9 e2 f4 ff ff       	jmp    80105895 <alltraps>
...
801063b5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801063ba:	e9 d6 f4 ff ff       	jmp    80105895 <alltraps>
...
801063c1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801063c6:	e9 ca f4 ff ff       	jmp    80105895 <alltraps>
...
801063cd:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801063d2:	e9 be f4 ff ff       	jmp    80105895 <alltraps>
...
801063d9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801063de:	e9 b2 f4 ff ff       	jmp    80105895 <alltraps>
...
801063e5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801063ea:	e9 a6 f4 ff ff       	jmp    80105895 <alltraps>
...
801063f1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801063f6:	e9 9a f4 ff ff       	jmp    80105895 <alltraps>
...
801063fd:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106402:	e9 8e f4 ff ff       	jmp    80105895 <alltraps>
...
80106409:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010640e:	e9 82 f4 ff ff       	jmp    80105895 <alltraps>
...
80106415:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010641a:	e9 76 f4 ff ff       	jmp    80105895 <alltraps>
...
80106421:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106426:	e9 6a f4 ff ff       	jmp    80105895 <alltraps>
...
8010642d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106432:	e9 5e f4 ff ff       	jmp    80105895 <alltraps>
...
80106439:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010643e:	e9 52 f4 ff ff       	jmp    80105895 <alltraps>
...
80106445:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010644a:	e9 46 f4 ff ff       	jmp    80105895 <alltraps>
...
80106451:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106456:	e9 3a f4 ff ff       	jmp    80105895 <alltraps>
...
8010645d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106462:	e9 2e f4 ff ff       	jmp    80105895 <alltraps>
...
80106469:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010646e:	e9 22 f4 ff ff       	jmp    80105895 <alltraps>
...
80106475:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010647a:	e9 16 f4 ff ff       	jmp    80105895 <alltraps>
...
80106481:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106486:	e9 0a f4 ff ff       	jmp    80105895 <alltraps>
...
8010648d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106492:	e9 fe f3 ff ff       	jmp    80105895 <alltraps>
...
80106499:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010649e:	e9 f2 f3 ff ff       	jmp    80105895 <alltraps>
...
801064a5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801064aa:	e9 e6 f3 ff ff       	jmp    80105895 <alltraps>
...
801064b1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801064b6:	e9 da f3 ff ff       	jmp    80105895 <alltraps>
...
801064bd:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801064c2:	e9 ce f3 ff ff       	jmp    80105895 <alltraps>
...
801064c9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801064ce:	e9 c2 f3 ff ff       	jmp    80105895 <alltraps>
...
801064d5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801064da:	e9 b6 f3 ff ff       	jmp    80105895 <alltraps>
...
801064e1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801064e6:	e9 aa f3 ff ff       	jmp    80105895 <alltraps>
...
801064ed:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801064f2:	e9 9e f3 ff ff       	jmp    80105895 <alltraps>
...
801064f9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801064fe:	e9 92 f3 ff ff       	jmp    80105895 <alltraps>
...
80106505:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010650a:	e9 86 f3 ff ff       	jmp    80105895 <alltraps>
...
80106511:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106516:	e9 7a f3 ff ff       	jmp    80105895 <alltraps>
...
8010651d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106522:	e9 6e f3 ff ff       	jmp    80105895 <alltraps>
...
80106529:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010652e:	e9 62 f3 ff ff       	jmp    80105895 <alltraps>
...
80106535:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010653a:	e9 56 f3 ff ff       	jmp    80105895 <alltraps>
...
80106541:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106546:	e9 4a f3 ff ff       	jmp    80105895 <alltraps>
...
8010654d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106552:	e9 3e f3 ff ff       	jmp    80105895 <alltraps>
...
80106559:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010655e:	e9 32 f3 ff ff       	jmp    80105895 <alltraps>
...
80106565:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010656a:	e9 26 f3 ff ff       	jmp    80105895 <alltraps>
...
80106571:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106576:	e9 1a f3 ff ff       	jmp    80105895 <alltraps>
...
8010657d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106582:	e9 0e f3 ff ff       	jmp    80105895 <alltraps>
...
80106589:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010658e:	e9 02 f3 ff ff       	jmp    80105895 <alltraps>
...
80106595:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010659a:	e9 f6 f2 ff ff       	jmp    80105895 <alltraps>
...
801065a1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801065a6:	e9 ea f2 ff ff       	jmp    80105895 <alltraps>
...
801065ad:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801065b2:	e9 de f2 ff ff       	jmp    80105895 <alltraps>
...
801065b9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801065be:	e9 d2 f2 ff ff       	jmp    80105895 <alltraps>
...
801065c5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801065ca:	e9 c6 f2 ff ff       	jmp    80105895 <alltraps>
...
801065d1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801065d6:	e9 ba f2 ff ff       	jmp    80105895 <alltraps>
...
801065dd:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801065e2:	e9 ae f2 ff ff       	jmp    80105895 <alltraps>
...
801065e9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801065ee:	e9 a2 f2 ff ff       	jmp    80105895 <alltraps>
...
801065f5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801065fa:	e9 96 f2 ff ff       	jmp    80105895 <alltraps>
...
80106601:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106606:	e9 8a f2 ff ff       	jmp    80105895 <alltraps>
...
8010660d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106612:	e9 7e f2 ff ff       	jmp    80105895 <alltraps>
...
80106619:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010661e:	e9 72 f2 ff ff       	jmp    80105895 <alltraps>
...
80106625:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010662a:	e9 66 f2 ff ff       	jmp    80105895 <alltraps>
...
80106631:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106636:	e9 5a f2 ff ff       	jmp    80105895 <alltraps>
...
8010663d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106642:	e9 4e f2 ff ff       	jmp    80105895 <alltraps>
...
80106649:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010664e:	e9 42 f2 ff ff       	jmp    80105895 <alltraps>
...
80106655:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010665a:	e9 36 f2 ff ff       	jmp    80105895 <alltraps>
...
80106661:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106666:	e9 2a f2 ff ff       	jmp    80105895 <alltraps>
...
8010666d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106672:	e9 1e f2 ff ff       	jmp    80105895 <alltraps>
...
80106679:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010667e:	e9 12 f2 ff ff       	jmp    80105895 <alltraps>
...
80106685:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010668a:	e9 06 f2 ff ff       	jmp    80105895 <alltraps>
...
80106691:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106696:	e9 fa f1 ff ff       	jmp    80105895 <alltraps>
...
8010669d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801066a2:	e9 ee f1 ff ff       	jmp    80105895 <alltraps>
...
801066a9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801066ae:	e9 e2 f1 ff ff       	jmp    80105895 <alltraps>
...
801066b5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801066ba:	e9 d6 f1 ff ff       	jmp    80105895 <alltraps>
...
801066c1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801066c6:	e9 ca f1 ff ff       	jmp    80105895 <alltraps>
...
801066cd:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801066d2:	e9 be f1 ff ff       	jmp    80105895 <alltraps>
...
801066d9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801066de:	e9 b2 f1 ff ff       	jmp    80105895 <alltraps>
...
801066e5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801066ea:	e9 a6 f1 ff ff       	jmp    80105895 <alltraps>
...
801066f1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801066f6:	e9 9a f1 ff ff       	jmp    80105895 <alltraps>
...
801066fd:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106702:	e9 8e f1 ff ff       	jmp    80105895 <alltraps>
...
80106709:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010670e:	e9 82 f1 ff ff       	jmp    80105895 <alltraps>
...
80106715:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010671a:	e9 76 f1 ff ff       	jmp    80105895 <alltraps>
...
80106721:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106726:	e9 6a f1 ff ff       	jmp    80105895 <alltraps>
...
8010672d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106732:	e9 5e f1 ff ff       	jmp    80105895 <alltraps>
...
80106739:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010673e:	e9 52 f1 ff ff       	jmp    80105895 <alltraps>
...
80106745:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010674a:	e9 46 f1 ff ff       	jmp    80105895 <alltraps>
...
80106751:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106756:	e9 3a f1 ff ff       	jmp    80105895 <alltraps>
...
8010675d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106762:	e9 2e f1 ff ff       	jmp    80105895 <alltraps>
...
80106769:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010676e:	e9 22 f1 ff ff       	jmp    80105895 <alltraps>
...
80106775:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010677a:	e9 16 f1 ff ff       	jmp    80105895 <alltraps>
...
80106781:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106786:	e9 0a f1 ff ff       	jmp    80105895 <alltraps>
...
8010678d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106792:	e9 fe f0 ff ff       	jmp    80105895 <alltraps>
...
80106799:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010679e:	e9 f2 f0 ff ff       	jmp    80105895 <alltraps>
...
801067a5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801067aa:	e9 e6 f0 ff ff       	jmp    80105895 <alltraps>
...
801067b1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801067b6:	e9 da f0 ff ff       	jmp    80105895 <alltraps>
...
801067bd:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801067c2:	e9 ce f0 ff ff       	jmp    80105895 <alltraps>
...
801067c9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801067ce:	e9 c2 f0 ff ff       	jmp    80105895 <alltraps>
...
801067d5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801067da:	e9 b6 f0 ff ff       	jmp    80105895 <alltraps>
...
801067e1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801067e6:	e9 aa f0 ff ff       	jmp    80105895 <alltraps>
...
801067ed:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801067f2:	e9 9e f0 ff ff       	jmp    80105895 <alltraps>
...
80106945:	e8 66 dd ff ff       	call   801046b0 <memset>
...
8010698d:	68 cc 7a 10 80       	push   $0x80107acc
...
801069a3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801069a6:	e8 a5 cf ff ff       	call   80103950 <cpuid>
  pd[0] = size-1;
...
80106a6f:	e8 7c ce ff ff       	call   801038f0 <mycpu>
80106a74:	89 c3                	mov    %eax,%ebx
80106a76:	e8 75 ce ff ff       	call   801038f0 <mycpu>
...
80106a88:	e8 63 ce ff ff       	call   801038f0 <mycpu>
...
80106ad1:	e8 1a ce ff ff       	call   801038f0 <mycpu>
...
80106af4:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106af7:	e8 f4 cd ff ff       	call   801038f0 <mycpu>
...
80106b7f:	e8 2c db ff ff       	call   801046b0 <memset>
...
80106bb2:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106bb3:	e9 98 db ff ff       	jmp    80104750 <memmove>
    panic("inituvm: more than a page");
80106bb8:	83 ec 0c             	sub    $0xc,%esp
80106bbb:	68 11 7b 10 80       	push   $0x80107b11
...
80106c20:	68 2b 7b 10 80       	push   $0x80107b2b
...
80106ca8:	68 cc 7b 10 80       	push   $0x80107bcc
...
80106d49:	68 49 7b 10 80       	push   $0x80107b49
...
80106dab:	68 61 7b 10 80       	push   $0x80107b61
...
80106e8c:	68 7d 7b 10 80       	push   $0x80107b7d
...
80106ec0:	e8 eb d7 ff ff       	call   801046b0 <memset>
...
80106f5c:	68 8e 7b 10 80       	push   $0x80107b8e
...
80106fd2:	68 98 7b 10 80       	push   $0x80107b98
...
80107030:	e8 1b d7 ff ff       	call   80104750 <memmove>
...
801070a7:	68 b2 7b 10 80       	push   $0x80107bb2
...
80107160:	e8 eb d5 ff ff       	call   80104750 <memmove>
    len -= n;
    buf += n;
