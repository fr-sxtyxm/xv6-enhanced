...
main(int argc, char *argv[])
{
   ...
   3:	83 e4 f0             	and    $0xfffffff0,%esp
    prsd();
   6:	e8 f8 02 00 00       	call   303 <prsd>
    exit();
 ...
 561:	a1 e8 09 00 00       	mov    0x9e8,%eax
{
 ...
 5a1:	5b                   	pop    %ebx
  freep = p;
 5a2:	89 15 e8 09 00 00    	mov    %edx,0x9e8
}
 5a8:	5e                   	pop    %esi
 5a9:	5f                   	pop    %edi
 5aa:	5d                   	pop    %ebp
 ...
 5d9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 5dc:	89 15 e8 09 00 00    	mov    %edx,0x9e8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 5f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 5fc:	8b 3d e8 09 00 00    	mov    0x9e8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 63f:	73 4f                	jae    690 <malloc+0xa0>
    ...
    if(p == freep)
 641:	8b 3d e8 09 00 00    	mov    0x9e8,%edi
 ...
 66a:	e8 f1 fe ff ff       	call   560 <free>
  return freep;
 66f:	8b 15 e8 09 00 00    	mov    0x9e8,%edx
 ...
 69c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 69f:	89 15 e8 09 00 00    	mov    %edx,0x9e8
}
 ...
 6af:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 6b0:	c7 05 e8 09 00 00 ec 	movl   $0x9ec,0x9e8
 6b7:	09 00 00 
    base.s.size = 0;
 6ba:	bf ec 09 00 00       	mov    $0x9ec,%edi
    base.s.ptr = freep = prevp = &base;
 6bf:	c7 05 ec 09 00 00 ec 	movl   $0x9ec,0x9ec
 6c6:	09 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 6c9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 6cb:	c7 05 f0 09 00 00 00 	movl   $0x0,0x9f0
 6d2:	00 00 00 
    if(p->s.size >= nunits){
